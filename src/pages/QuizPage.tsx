...
const QuizPage: React.FC = () => {
  ...
  const { timeRemaining, percentRemaining, startTimer, isActive } = useTimer({
            ...
            <div className="md:col-span-4">
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-lg p-4">
                ...
                <ul className="text-sm text-blue-700 space-y-1">
                  ...
                  <li>
                    • Use the navigation buttons or question numbers to move
                    between questions
                  </li>
            ...
            <p className="text-gray-700 mb-4">
              ...
              {answeredCount < questions.length && (
                <span className="text-orange-600 font-medium block mt-1">
                  {questions.length - answeredCount} question(s) will be counted
                  as incorrect.
                </span>
              )}
            </p>
